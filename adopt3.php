        ...
        <div class="BodyContainer" >
            ...
            <div class="padding">
                ...
                <p>
                    ...
                    information.  These are best guess descriptions for breed.  SOS NEVER ships
                    pets and will not adopt out to a driving radius greater than 3 hours from 
                    Medina, Ohio.
                </p>
                <p>
                    Please remember to license all dogs in Ohio. It is a state law, and it is 
                    your dog's ticket home if lost. You may order a license online 
                    <a href="#">here</a></p>
                <p class="petattention">
                    Many of the animals listed are strays and may belong to someone.
                    Please see if you recognize them</p>
                <div class="center">
                <table class="adopt">
                <tr>
                    <td class="AdoptPic" style="border-right:1px solid #000">
                        <img src="Images/AuditorSeal.png" class="AdoptImage" alt=""/>
                    </td>
                    <td class="AdoptInfo">
                        Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus interdum leo in velit vulputate hendrerit. Curabitur imperdiet nisl id arcu ultricies pharetra. Fusce sollicitudin velit quis nisl suscipit, in egestas dolor faucibus. Mauris id velit non diam tempor maximus. Donec nec sollicitudin erat. Donec ex sem, lobortis sit amet semper sed, viverra non dolor. Fusce pharetra aliquam tortor non eleifend.
                    </td>                    
                </tr>
                </table>
                <table class="adopt">
