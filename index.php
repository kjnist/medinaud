...
<body>
 ...
 <section>
	...
	<p class="body"><font face="Arial" size="2">Taxing District:
            <select class="input" name="taxdist" size="1" style="width: 100%;">
            <option value="0" selected="selected">-Select-</option>
    ...
    <input class="buttonres" type="reset" value="Reset"></font></p>
            ...
            <aside>              
                <img src="http://www.medinacountyauditor.org/images/Jazz.jpg" usemap="#Map" border="0" class="FrontPage">
                <map name="Map">
                <area shape="rect" coords="247,206,417,284" href="http://ormaco.org/" target="_blank" alt="ORMACO Presents Jazz Under the Stars 2015">
              </map>
            </aside>      
            <section class="right">
