...
<html>
            ...
            <section>
                <div class="PropertyForm" style="padding:4px;">
                    <form  action="http://www.medinacountyauditor.org/propsearch_php.php" method="post" name="propsearch" id="propsearch">
                        ...
                        <p class="directions" style="margin: 0px 0px 0px 15px"><i>
                            <font face="Arial" size="2" color="#000000">Enter Last Name</font></i></p>  
                        <p class="body"><font face="Arial" size="2">Owner: 
                        <input style="float: right" type="text" name="Owner" class="input"></font></p>    
                        <p class="directions" style="margin: 0px 0px 30px 15px"><i>
                            <font face="Arial" size="2" color="#000000">Narrow search by entering<br>
                            last name (space) first name.</font></i></p>  
                        <p class="body"><font face="Arial" size="2">Address:
                        <input style="float: right" type="text" name="Address" class="input"></font></p>   
                        <p class="body"><font face="Arial" size="2">Parcel Number:    
                        ...
                        <p class="body"><font face="Arial" size="2">City:
                            <input style="float: right" type="text" name="City" class="input"></font></p>
                        <p class="body" style="width: 100"><font face="Arial" size="2">Taxing District:
                        <select style="width: 100%;" name="Tax" size="1" class="input">
                        ...
                        <input type="reset" value="Reset" class="buttonres"></font></p>  
                        <p class="footer"></p><center>
                            <font face="Arial" color="#000000" style="font-size: 11pt">If your search is 
                            not successful try less information. Only fill in one search criterion.</font></center><p></p>    
                        <p class="subfooter"></p><center><i><font face="Arial" size="2">For information 
                            on how to use the search engines, 
                        <br>please refer to <a href="searchtips.htm">Search Tips &amp; Limitations</a>.</font></i></center><p></p>
                    </form>      
                </div> 
	...
	<h3 style="text-align: center; font-weight: normal">Calculate 2014 Real Estate Taxes</h3>
	<p class="body"><font face="Arial" size="2">Taxing District:
            <select class="input" name="taxdist" size="1" style="width: 250px;">
    	<option value="0" selected="selected">-Select-</option>
    ...
    <p class="body"><font face="Arial" size="2">Property Value:
    <input class="input" type="text" name="amount"></font></p>
    <p class="body"><font face="Arial" size="2">Is Parcel 
	Residential/Agricultural? 
    <input class="buttons" type="radio" name="type" value="res" checked=""></font></p>
    <p class="body"><font face="Arial" size="2">Is Parcel Commercial/Other?
    <input class="buttons" type="radio" name="type" value="comm"></font></p> 
    <p class="body"><font face="Arial" size="2">Is Parcel Owner Occupied?
    <input class="buttons" type="checkbox" name="owner" value="own"></font></p>
    <p><font face="Arial" size="2">
    <input class="buttonsub" type="submit" value="Submit">
    <input class="buttonres" type="reset" value="Reset"></font></p>
                </form><p style="font-size: .7em">
            ...
            <aside>
                <img src="Images/4July2015.png" style="width: 100%;box-shadow: 1px 1px 10px;" alt=""/>
            </aside>      
            <section class="right">
                ...
                <div class="BoxRight" style="padding:5px;">
                ...
                <div class="BoxRight" style="padding:5px;text-align: center">
                    ...
                    <a href="#"><img src="Images/Social/email.png" class="social" alt="" /></a>
                    <a href="#"><img src="Images/Social/Youtube.png" class="social" alt="" /></a>
                    <a class="twitter-follow-button" href="https://twitter.com/MedinaAuditor" data-show-screen-name="false">Follow @MedinaAuditor</a>
        ...
        <div class="wrapperFoot"> 
            <nav class="Footer">
                <ul>
                    ...
                    <li><a href="#">Help</a></li>
                    <li><a href="#" class="WORK">Employment</a></li>
